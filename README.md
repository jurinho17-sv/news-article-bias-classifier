...
**[Model card on HuggingFace →](https://huggingface.co/jurinho17-sv/news-article-bias-classifier)** (Cumulative <!-- HF_DOWNLOADS_START -->152<!-- HF_DOWNLOADS_END --> downloads! I can't believe it!)
